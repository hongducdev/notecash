...
const NotificationLogSchema = CollectionSchema(
  ...
  properties: {
    r'isBankRelated': PropertySchema(
      id: 0,
      name: r'isBankRelated',
      type: IsarType.bool,
    ),
...
void _notificationLogSerialize(
  ...
  writer.writeBool(offsets[0], object.isBankRelated);
...
NotificationLog _notificationLogDeserialize(
  ...
  object.id = id;
  object.isBankRelated = reader.readBool(offsets[0]);
  object.isIncome = reader.readBoolOrNull(offsets[1]);
...
void _notificationLogAttach(
    IsarCollection<dynamic> col, Id id, NotificationLog object) {
  object.id = id;
}
...
extension NotificationLogQueryFilter
  ...
  QueryBuilder<NotificationLog, NotificationLog, QAfterFilterCondition>
      isBankRelatedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isBankRelated',
        value: value,
      ));
    });
  }
...
extension NotificationLogQuerySortBy
  ...
  QueryBuilder<NotificationLog, NotificationLog, QAfterSortBy>
      sortByIsBankRelated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBankRelated', Sort.asc);
    });
  }

  QueryBuilder<NotificationLog, NotificationLog, QAfterSortBy>
      sortByIsBankRelatedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBankRelated', Sort.desc);
    });
  }
  ...
  QueryBuilder<NotificationLog, NotificationLog, QAfterSortBy> sortByIsRead() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationLog, NotificationLog, QAfterSortBy> sortByText() {
    return QueryBuilder.apply(this, (query) {
...
extension NotificationLogQuerySortThenBy
  ...
  QueryBuilder<NotificationLog, NotificationLog, QAfterSortBy> thenByIsRead() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRead', Sort.asc);
    });
  }
  ...
  QueryBuilder<NotificationLog, NotificationLog, QAfterSortBy> thenByText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.asc);
    });
  }
...
extension NotificationLogQueryWhereDistinct
  ...
  QueryBuilder<NotificationLog, NotificationLog, QDistinct>
      distinctByIsBankRelated() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isBankRelated');
    });
  }
  ...
  QueryBuilder<NotificationLog, NotificationLog, QDistinct> distinctByIsRead() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationLog, NotificationLog, QDistinct> distinctByText(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension NotificationLogQueryProperty
  ...
  QueryBuilder<NotificationLog, bool, QQueryOperations>
      isBankRelatedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isBankRelated');
    });
  }

  QueryBuilder<NotificationLog, bool?, QQueryOperations> isIncomeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isIncome');
    });
  }

  QueryBuilder<NotificationLog, bool, QQueryOperations> isReadProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isRead');
    });
  }

  QueryBuilder<NotificationLog, String?, QQueryOperations>
      packageNameProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationLog, double?, QQueryOperations>
  ...
  QueryBuilder<NotificationLog, String?, QQueryOperations> textProperty() {
    return QueryBuilder.apply(this, (query) {
